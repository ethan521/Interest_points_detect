...
def hourglass_module(inputs, depth=0, deconv='bilinear', bottleneck='bottleneck'):
    ...
    with tf.variable_scope('depth_{}'.format(depth)):
        ...
        print('depth_{}'.format(depth), 'pool', net.get_shape())
        net = slim.stack(net, bm_fn, [
            (256 // 2, None), (256 // 2, None), (256 // 2, None) ], scope='buttom_up')
        print('depth_{}'.format(depth), 'stack', net.get_shape())
        ...
        if depth > 0:
            ...
            net = bm_fn(
                net, out_channel=512 // 2, res=512 // 2, scope='connecting')
        print('depth_{}'.format(depth), 'connecting', net.get_shape())

        # top down layers
        net = bm_fn(net, out_channel=512 // 2,
                    res=512 // 2, scope='top_down')
        print('depth_{}'.format(depth), 'top_down', net.get_shape())
        net = deconv_layer(net, 2, 512 // 2, method=deconv)
        # residual layers
        net += slim.stack(inputs, bm_fn,
                          [ (256 // 2, None), (256 // 2, None), (512 // 2, 512 // 2) ], scope='res')
        print('depth_{}'.format(depth), 'res', net.get_shape())
...
def hourglass(inputs,
    ...
    with slim.arg_scope(hourglass_arg_scope_tf()):
        # D1
        net = slim.conv2d(inputs, 64 // 2, (7, 7), 2, scope='conv1')
        print('conv1', net.get_shape())
        net = bottleneck_module(net, out_channel=128 // 2,
                                res=128 // 2, scope='bottleneck1')
        print('bottleneck1', net.get_shape())
        net = slim.max_pool2d(net, [ 2, 2 ], scope='pool1')
        print('pool1', net.get_shape())

        # D2
        net = slim.stack(net, bottleneck_module, [
            (128 // 2, None), (128 // 2, None), (256 // 2, 256 // 2) ], scope='conv2')
        print('conv2', net.get_shape())

        # hourglasses (D3,D4,D5)
        with tf.variable_scope('hourglass'):
            net = hourglass_module(
                net, depth=1, deconv=deconv, bottleneck=bottleneck)
        print('hourglass', net.get_shape())

        # final layers (D6, D7)
        net = slim.stack(net, slim.conv2d, [ (512 // 2, [ 1, 1 ]), (256 // 2, [ 1, 1 ]),
                                             (output_channels, [ 1, 1 ])
                                             ], scope='conv3')
                                                    ...
                                                    with tf.name_scope('nn.ConcatTable'):
                                                        ...
                                                        with tf.name_scope('nn.Sequential'):
                                                            ...
                                                            net0000 = tf.pad(net0000, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0000 = slim.conv2d(
                                                                net0000, 128, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                            net0000 = slim.batch_norm(
                                                                net0000)
                                                            net0000 = slim.nn.relu(
                                                            ...
                                                            net0000 = tf.pad(net0000, np.array(
                                                                [ [ 0, 0 ], [ 1, 1 ], [ 1, 1 ], [ 0, 0 ] ]))
                                                            net0000 = slim.conv2d(
                                                                net0000, 128, (3, 3), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                            net0000 = slim.batch_norm(
                                                                net0000)
                                                            net0000 = slim.nn.relu(
                                                            ...
                                                            net0000 = tf.pad(net0000, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0000 = slim.conv2d(
                                                                net0000, 256, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                        net0001 = net000
                                                    net000 = tf.add_n(
                                                        [ net0000, net0001 ])
                                                        ...
                                                        with tf.name_scope('nn.ConcatTable'):
                                                            ...
                                                            with tf.name_scope('nn.Sequential'):
                                                                ...
                                                                net0000 = tf.pad(net0000, np.array(
                                                                    [ [ 0, 0 ], [ 1, 1 ], [ 1, 1 ], [ 0, 0 ] ]))
                                                                net0000 = slim.conv2d(
                                                                    net0000, 256, (3, 3), (1, 1), activation_fn=None,
                                                                    padding='VALID')
                                                                net0000 = slim.batch_norm(
                                                                    net0000)
                                                                net0000 = slim.nn.relu(
                                                                ...
                                                                net0000 = tf.pad(net0000, np.array(
                                                                    [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                                net0000 = slim.conv2d(
                                                                    net0000, 512, (1, 1), (1, 1), activation_fn=None,
                                                                    padding='VALID')
                                                            net0001 = net000
                                                        net000 = tf.add_n(
                                                            [ net0000, net0001 ])
                                                    ...
                                                    with tf.name_scope('nn.ConcatTable'):
                                                        ...
                                                        with tf.name_scope('nn.Sequential'):
                                                            ...
                                                            net0010 = tf.pad(net0010, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0010 = slim.conv2d(
                                                                net0010, 128, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                            net0010 = slim.batch_norm(
                                                                net0010)
                                                            net0010 = slim.nn.relu(
                                                            ...
                                                            net0010 = tf.pad(net0010, np.array(
                                                                [ [ 0, 0 ], [ 1, 1 ], [ 1, 1 ], [ 0, 0 ] ]))
                                                            net0010 = slim.conv2d(
                                                                net0010, 128, (3, 3), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                            net0010 = slim.batch_norm(
                                                                net0010)
                                                            net0010 = slim.nn.relu(
                                                            ...
                                                            net0010 = tf.pad(net0010, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0010 = slim.conv2d(
                                                                net0010, 256, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                        net0011 = net001
                                                    net001 = tf.add_n(
                                                        [ net0010, net0011 ])
                                                    ...
                                                    with tf.name_scope('nn.ConcatTable'):
                                                        ...
                                                        with tf.name_scope('nn.Sequential'):
                                                            ...
                                                            net0010 = tf.pad(net0010, np.array(
                                                                [ [ 0, 0 ], [ 1, 1 ], [ 1, 1 ], [ 0, 0 ] ]))
                                                            net0010 = slim.conv2d(
                                                                net0010, 256, (3, 3), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                            net0010 = slim.batch_norm(
                                                                net0010)
                                                            net0010 = slim.nn.relu(
                                                            ...
                                                            net0010 = tf.pad(net0010, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0010 = slim.conv2d(
                                                                net0010, 512, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                        net0011 = net001
                                                        with tf.name_scope('nn.Sequential'):
                                                            net0011 = tf.pad(net0011, np.array(
                                                                [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                            net0011 = slim.conv2d(
                                                                net0011, 512, (1, 1), (1, 1), activation_fn=None,
                                                                padding='VALID')
                                                    net001 = tf.add_n(
                                                        [ net0010, net0011 ])
                                        net00 = tf.add_n([ net000, net001 ])
                                            ...
                                            with tf.name_scope('nn.ConcatTable'):
                                                ...
                                                with tf.name_scope('nn.Sequential'):
                                                    ...
                                                    net000 = tf.pad(net000, np.array(
                                                        [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                    net000 = slim.conv2d(
                                                        net000, 256, (1, 1), (1, 1), activation_fn=None,
                                                        padding='VALID')
                                                    net000 = slim.batch_norm(
                                                        net000)
                                                    net000 = slim.nn.relu(
                                                    ...
                                                    net000 = tf.pad(net000, np.array(
                                                        [ [ 0, 0 ], [ 1, 1 ], [ 1, 1 ], [ 0, 0 ] ]))
                                                    net000 = slim.conv2d(
                                                        net000, 256, (3, 3), (1, 1), activation_fn=None,
                                                        padding='VALID')
                                                    net000 = slim.batch_norm(
                                                        net000)
                                                    net000 = slim.nn.relu(
                                                    ...
                                                    net000 = tf.pad(net000, np.array(
                                                        [ [ 0, 0 ], [ 0, 0 ], [ 0, 0 ], [ 0, 0 ] ]))
                                                    net000 = slim.conv2d(
                                                        net000, 512, (1, 1), (1, 1), activation_fn=None,
                                                        padding='VALID')
                                                net001 = net00
                                            net00 = tf.add_n([ net000, net001 ])
                                    net00 = tf.pad(net00, np.array(

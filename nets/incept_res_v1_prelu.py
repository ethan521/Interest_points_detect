...
# Inception-Renset-A
def block35(net, scale=1.0, activation_fn=prelu, scope=None, reuse=None):
...
# Inception-Renset-B
def block17(net, scale=1.0, activation_fn=prelu, scope=None, reuse=None):
...
# Inception-Resnet-C
def block8(net, scale=1.0, activation_fn=prelu, scope=None, reuse=None):
...
def inference(images, keep_probability, phase_train=True, weight_decay=0.0, reuse=None):
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        return incept_res_v1_prelu(images, is_training=phase_train,
              dropout_keep_prob=keep_probability, reuse=reuse)


def incept_res_v1_prelu(inputs, is_training=True,

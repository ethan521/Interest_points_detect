...
import nets.conv_blocks as ops
import nets.mobilenet2 as lib
...
def inference(images, keep_probability, phase_train=True, weight_decay=0.0, reuse=None):
    with tf.contrib.slim.arg_scope(
            training_scope(is_training=phase_train, weight_decay=weight_decay, dropout_keep_prob=keep_probability)):
        prelogit, end_points = mobilenet(images,
                                         depth_multiplier=1.0,
                                         finegrain_classification_mode=True,
